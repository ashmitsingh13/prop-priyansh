...
export const mockProperties: Properties[] = [
  {
    ...
    propertyType: 'Villa',
  location: 'Dholera / Noida Smart City, Gujarat',
  description: 'Spacious 3BHK villa with modern amenities, garden area, and smart home features. Perfect for families looking for comfort and luxury in the heart of Dholera / Noida.',
    price: 4500000,
    areaSqFt: 2500,
  ...
  location: 'Dholera / Noida SIR, Gujarat',
  ...
  location: 'Dholera / Noida Business District, Gujarat',
  ...
  },
  {
    ...
    propertyType: 'Duplex',
  location: 'Dholera / Noida Residential Area, Gujarat',
  ...
  },
  {
    ...
    propertyType: 'Apartment',
  location: 'Dholera / Noida Phase 2, Gujarat',
  ...
  },
  {
    ...
    propertyType: 'Plot',
  location: 'Dholera / Noida Investment Zone, Gujarat',
  description: 'Prime residential plot in the heart of Dholera / Noida Smart City. Ideal for building your dream home or as an investment opportunity.',
    price: 3200000,
    areaSqFt: 2000,
...
export const mockServices: Services[] = [
  ...
  shortDescription: 'Expert guidance on real estate investments in Dholera / Noida Smart City with market insights and ROI analysis.',
